import sys
from PyQt5.QtWidgets import QApplication, QWidget, QVBoxLayout, QPushButton, QInputDialog, QMessageBox, QDesktopWidget
...
class UniversalGUI(QWidget):
    def __init__(self):
        ...
        self.recycle_bin_gui = None  # Make RecycleBinCleanerGUI instance a class variable
    ...
    def open_recycle_bin_gui(self):
        if not self.recycle_bin_gui:
            ...
            self.recycle_bin_gui.move(QDesktopWidget().availableGeometry().center())
